<?php
/**
 * Template Name: Услуги для бизнеса (Legal Services)
 * Matches service-legal.html - Strictly from DB
 *
 * @package BelanAgency
 */
...
$yur_term = get_term_by('slug', 'dlya-yuridicheskih-lic', 'service_category');
$hero_title = $yur_term ? $yur_term->name : 'Для юридических лиц';
$hero_desc = $yur_term ? belan_get_term_desc($yur_term) : 'Надежная правовая поддержка бизнеса на всех этапах: от проверки контрагентов до представления интересов в арбитраже. Экономим ваше время и деньги, предотвращая споры еще до их возникновения.';
...
<section class="section services-catalog">
    <div class="container">
        <div class="section__header">
            <h2 class="section__title">Правовая помощь юридическим лицам:</h2>
        </div>
